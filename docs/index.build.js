...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lens = __webpack_require__(1);
	...
	var Root = new Vue({
	  ...
	  mounted: function mounted() {
	    var tourLens = new Lens('.tour-ctnr');
	  ...
	  methods: {
	    transform: function transform() {
	      ...
	      this.interval = setInterval(function () {
	        if (_this.show >= _this.contents.length - 1) {
	          _this.show = 0;
	        } else {
	          _this.show++;
	        }
	    ...
	    lensInit: function lensInit() {
	      var showCaseLens = new Lens('.show-case-ctnr');
	      showCaseLens.observe({ deepWatch: true });
	    },
	    stopTransform: function stopTransform() {
	    ...
	    registerEvents: function registerEvents() {
	      ...
	      events.forEach(function (event) {
	        window.addEventListener(event, function () {
	          ...
	          scrollTop > 350 ? _this2.stopTransform() : _this2.transform();
	        });
	      });
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty3 = __webpack_require__(3);
	...
	(function webpackUniversalModuleDefinition(root, factory) {
	   ...
	   */
			...
			exports.f = __webpack_require__(16) ? _defineProperty4.default : function defineProperty(O, P, Attributes) {
				anObject(O);
